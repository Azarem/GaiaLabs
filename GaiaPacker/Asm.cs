...
namespace GaiaPacker
{
    internal partial class Asm
    {
        ...
        public static readonly Dictionary<string, IEnumerable<OpCode>> OpCodes = new()
        {
            {"ADC", [
                new (){ Mnem = "ADC", Code = 0x69, Mode = AddressingMode.Immediate, Size = -2 },
                new (){ Mnem = "ADC", Code = 0x6D, Mode = AddressingMode.Absolute, Size = 3 },
                new (){ Mnem = "ADC", Code = 0x6F, Mode = AddressingMode.AbsoluteLong, Size = 4 },
                new (){ Mnem = "ADC", Code = 0x65, Mode = AddressingMode.DirectPage, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x72, Mode = AddressingMode.DirectPageIndirect, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x67, Mode = AddressingMode.DirectPageIndirectLong, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x7D, Mode = AddressingMode.AbsoluteIndexedX, Size = 3 },
                new (){ Mnem = "ADC", Code = 0x7F, Mode = AddressingMode.AbsoluteLongIndexedX, Size = 4 },
                new (){ Mnem = "ADC", Code = 0x79, Mode = AddressingMode.AbsoluteIndexedY, Size = 3 },
                new (){ Mnem = "ADC", Code = 0x75, Mode = AddressingMode.DirectPageIndexedX, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x61, Mode = AddressingMode.DirectPageIndexedIndirectX, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x71, Mode = AddressingMode.DirectPageIndirectIndexedY, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x77, Mode = AddressingMode.DirectPageIndirectLongIndexedY, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x63, Mode = AddressingMode.StackRelative, Size = 2 },
                new (){ Mnem = "ADC", Code = 0x73, Mode = AddressingMode.StackRelativeIndirectIndexedY, Size = 2 }
            ] },

            {"AND", [
                new (){ Mnem = "AND", Code = 0x29, Mode = AddressingMode.Immediate, Size = -2 },
                new (){ Mnem = "AND", Code = 0x2D, Mode = AddressingMode.Absolute, Size = 3 },
                new (){ Mnem = "AND", Code = 0x2F, Mode = AddressingMode.AbsoluteLong, Size = 4 },
                new (){ Mnem = "AND", Code = 0x25, Mode = AddressingMode.DirectPage, Size = 2 },
                new (){ Mnem = "AND", Code = 0x32, Mode = AddressingMode.DirectPageIndirect, Size = 2 },
                new (){ Mnem = "AND", Code = 0x27, Mode = AddressingMode.DirectPageIndirectLong, Size = 2 },
                new (){ Mnem = "AND", Code = 0x3D, Mode = AddressingMode.AbsoluteIndexedX, Size = 3 },
                new (){ Mnem = "AND", Code = 0x3F, Mode = AddressingMode.AbsoluteLongIndexedX, Size = 4 },
                new (){ Mnem = "AND", Code = 0x39, Mode = AddressingMode.AbsoluteIndexedY, Size = 3 },
                new (){ Mnem = "AND", Code = 0x35, Mode = AddressingMode.DirectPageIndexedX, Size = 2 },
                new (){ Mnem = "AND", Code = 0x21, Mode = AddressingMode.DirectPageIndexedIndirectX, Size = 2 },
                new (){ Mnem = "AND", Code = 0x31, Mode = AddressingMode.DirectPageIndirectIndexedY, Size = 2 },
                new (){ Mnem = "AND", Code = 0x37, Mode = AddressingMode.DirectPageIndirectLongIndexedY, Size = 2 },
                new (){ Mnem = "AND", Code = 0x23, Mode = AddressingMode.StackRelative, Size = 2 },
                new (){ Mnem = "AND", Code = 0x33, Mode = AddressingMode.StackRelativeIndirectIndexedY, Size = 2 },
            ] },
